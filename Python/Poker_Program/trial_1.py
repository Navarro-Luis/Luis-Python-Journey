...
def bet_raise_player1():
    global player1_stack
    global pot_size

    player_raise_size = input('How much would you like to raise?')
    player_raise_size = int(player_raise_size)
    print(f'Player 1 raise is {player_raise_size}')
    player1_stack = player1_stack - player_raise_size
    pot_size = pot_size + player_raise_size
    print(f'Player 1 stack size is now {player1_stack}')
    return f'The pot is now {pot_size}'





print(bet_raise_player1())
